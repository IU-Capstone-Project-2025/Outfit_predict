...
def extract_item_description(caption: str) -> str:
    ...
    Например:
    'The image shows a woman wearing black thigh high boots and gloves, standing on the floor with a wall in the background. The image is slightly blurred, giving it a dreamy, ethereal feel.'
    -> 'black thigh high boots and gloves'
    'The image shows a person holding a black handbag in their hand. The handbag is slightly blurred, giving it a dreamy, ethereal quality.'
    ...
    match = re.search(r'The image shows [^.,;]*? (wearing|holding)? ?([^.,;]+)', caption)
