...
from app.deps import get_db, get_current_user, get_minio
...
async def cleanup_user_data(
    ...
    """
    from app.crud import image as crud_image, outfit as outfit_crud
    ...
    try:
        ...
        user_images = await crud_image.list_images(db, current_user.id, skip=0, limit=10000)
        user_outfits = await outfit_crud.list_outfits(db, current_user.id, skip=0, limit=10000)
        ...
        valid_outfit_ids = {str(outfit.id) for outfit in user_outfits}
